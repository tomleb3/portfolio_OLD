...
export const HeroIcon = ({ isDarkMode = false }: { readonly isDarkMode: boolean }) => (
    <svg className='hero-icon' viewBox='0 0 650 265' version='1.1' xmlns='http://www.w3.org/2000/svg'>
        <title>hero</title>
        <g id='Website' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
            <g id='Group-32' transform='translate(0.000000, 3.000000)'>
                <path
                    className={isDarkMode ? 'fill-body--darkmode stroke-main--darkmode' : 'fill-body stroke-main'}
                ...
                ></path>
                <ellipse
                    className={isDarkMode ? 'stroke-main--darkmode' : 'stroke-main'}
                    id='Oval-6'
                    strokeWidth='2.08142999'
                    cx='260.215348'
                    cy='202.809335'
                ...
                ></path>
                <rect
                    className={isDarkMode ? 'fill-main--darkmode' : 'fill-main'}
                    id='Rectangle-11'
                    x='114.812374'
                    y='164.17279'
                    width='24.7328244'
