...
export const MenuIcon = ({ isDarkMode = false }: { readonly isDarkMode: boolean }) => (
    <svg xmlns='http://www.w3.org/2000/svg' height='30px' width='30px' x='0px' y='0px' viewBox='0 0 196.894 196.894'>
        <path
            className={isDarkMode ? 'fill-txt--darkmode' : 'fill-txt'}
            d='M26.008,72.443C11.667,72.443,0,84.11,0,98.447c0,14.34,11.667,26.004,26.008,26.004
        ...
        <path
            className={isDarkMode ? 'fill-txt--darkmode' : 'fill-txt'}
            d='M99.721,72.443c-14.34,0-26.008,11.667-26.008,26.004c0,14.34,11.667,26.004,26.008,26.004
        ...
        <path
            className={isDarkMode ? 'fill-txt--darkmode' : 'fill-txt'}
            d='M170.89,72.443c-14.344,0-26.011,11.667-26.011,26.004c0,14.34,11.667,26.004,26.011,26.004
